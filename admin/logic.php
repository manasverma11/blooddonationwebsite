<?php
    ...
    $conn = new mysqli("localhost","root","","majorproject",'3308');
	...
	mysqli_query($conn, "DELETE FROM jdoctor WHERE id=$id");
	echo $msg;
    echo $sql; 
	...
	mysqli_query($conn, "DELETE FROM jnurse WHERE id=$id");
	echo $msg;
    echo $sql; 
	...
	$id = $_REQUEST['delhtml'];
	mysqli_query($conn, "DELETE FROM jhtml WHERE id=$id");
	echo $msg;
    echo $sql; 
	...
	mysqli_query($conn, "DELETE FROM jcontent WHERE id=$id");
	echo $msg;
    echo $sql; 
