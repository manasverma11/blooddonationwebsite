    ...
    if ($conn->query($sql)){
      ...
      <html>
        ...
        <body onload = "getLocation();" data-home-page="index.php" data-home-page-title="Home" class="u-body"><header class="u-clearfix u-header u-header" id="sec-8c91"><div class="u-clearfix u-sheet u-sheet-1">
              ...
              <div class="u-hidden-md u-hidden-sm u-hidden-xs u-image u-image-circle u-preserve-proportions u-image-2" onclick="openMenu()" alt="" data-image-width="1280" data-image-height="1280"><img src="../profile_images/<?=$user['p_p']?>" style="width:100%;border-radius:100%;"></div>
      ...
      </li><li class="u-nav-item"><a id="aboutnav" class="u-border-hover-palette-1-light-1 u-button-style u-hover-grey-10 u-nav-link u-text-grey-90 u-text-hover-grey-90" href="about.php" style="padding: 10px 20px;">About</a>
