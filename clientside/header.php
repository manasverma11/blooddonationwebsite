...
<html>
  ...
  <body onload = "getLocation();" data-home-page="index.php" data-home-page-title="Home" class="u-body"><header class="u-clearfix u-header u-header" id="sec-8c91"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="#" class="u-image u-logo u-image-1" data-image-width="1500" data-image-height="1774">
          <img src="../images/blood.png" class="u-logo-image u-logo-image-1">
        </a>
        <?php
        $emailh = $user['email'];
        $default = "http://localhost/htdocs/profile_images/blood_hand.png";
        $grav_url_60 = "https://www.gravatar.com/avatar/" . md5( strtolower( trim( $emailh ) ) ) . "?d=" .$default . "&s=60";
        ?>
        <div class="u-hidden-md u-hidden-sm u-hidden-xs u-image u-image-circle u-preserve-proportions u-image-2" onclick="openMenu()" alt="" data-image-width="1280" data-image-height="1280"><img src="<?php echo $grav_url_60; ?>" style="width:100%;border-radius:100%;"></div>
...
<!-- <script type='text/javascript'>
		(function(I, L, T, i, c, k, s) {if(I.iticks) return;I.iticks = {host:c, settings:s, clientId:k, cdn:L, queue:[]};var h = T.head || T.documentElement;var e = T.createElement(i);var l = I.location;e.async = true;e.src = (L||c)+'/client/inject-v2.min.js';h.insertBefore(e, h.firstChild);I.iticks.call = function(a, b) {I.iticks.queue.push([a, b]);};})(window, 'https://cdn-v1.intelliticks.com/prod/common', document, 'script', 'https://app.intelliticks.com', 'NjR3JJrKZkXuEf4xG_c', {});
</script> -->
<!-- End of ChatBot code -->