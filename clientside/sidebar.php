<div class="w3-sidebar w3-bar-block w3-card w3-animate-right" style="display:none;right:0;top:0;text-align: center;" id="menu">
      ...
      $grav_url_80 = "https://www.gravatar.com/avatar/" . md5( strtolower( trim( $emailh ) ) ) . "?d=" . urlencode( $default ) . "&s=80";
      ?>
      <center><img src="<?php echo $grav_url_80; ?>" alt="" style="border-radius:100%;border:1px solid black;" /></center>
