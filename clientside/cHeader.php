...
<html>
  ...
  <body onload = "getLocation();" data-home-page="index.php" data-home-page-title="Home" class="u-body"><header class="u-clearfix u-header u-header" id="sec-8c91"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <?php
        $emailh = $user['email'];
        $grav_url_60 = "https://www.gravatar.com/avatar/" . md5( strtolower( trim( $emailh ) ) ) . "?d=NotFound&s=60";
        ?>
        <div class="u-hidden-md u-hidden-sm u-hidden-xs u-image u-image-circle u-preserve-proportions u-image-2" onclick="openMenu()" alt="" data-image-width="1280" data-image-height="1280">
          <?php
            if (imageExists($grav_url_60)) echo '<img src="'.$grav_url_60.'" style="width:100%;border-radius:100%;border:1px solid black;">';
            else echo '<img src="../profile_images/'.$user['p_p'].'" style="width:100%;border-radius:100%;border:1px solid black;">';
          ?>
        </div>
