...
<div class="col-md-6 offset-md-3 mt-5">
    <p class="h1">You are Applying For Doctor Job In Blood Donation Website</p>
    <form action="cvdoctor.php" method="POST" enctype="multipart/form-data" class="py-3">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <input type="text" name="spec" class="form-control" id="spec" placeholder="Heart"required="required">
        </div>
        <div class="form-group col-md-6">
        <label for="tel">Telephone</label>
          <input class="form-control" name="tel" type="tel" placeholder="+91xxxxxxxxxx" id="tel"required="required">
        </div>
      </div>
