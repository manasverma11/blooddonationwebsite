...
<p class="h1">You are Applying For Web Developer Job In Blood Donation Website</p>
    <form action="cvhtml.php" method="POST" enctype="multipart/form-data" class="py-3">
